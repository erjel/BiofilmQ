...
for i = range
    if isdir(fullfile(folders{i}))
        ...
        handles.uicontrols.edit.registrationReferenceFrame.String = numel(handles.settings.lists.files_tif);
        ...
        set(handles.menuHandles.menues.menu_process_all_select_registerImages, 'Checked', 'on');
