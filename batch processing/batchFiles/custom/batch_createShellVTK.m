...
for i = range
    if isdir(fullfile(folders{i}))
        ...
        handles.uitables.intensity_tasks.Data = {'Visualize extracellular fluorophores (creates vtk-files)', '8', '2', true, true, false, false};
        handles.uitables.cellParametersCalculate.Data(:,2) = num2cell(false(size(handles.uitables.cellParametersCalculate.Data(:,2), 2), 1));
        handles.uitables.cellParametersCalculate.Data{21,2} = true;
